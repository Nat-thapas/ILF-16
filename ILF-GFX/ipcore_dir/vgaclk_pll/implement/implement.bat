...
xst -ifn xst.scr
move vgaclk_pll_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\vgaclk_pll_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc vgaclk_pll_exdes.ucf vgaclk_pll_exdes

echo 'Running map'
map -timing -pr b vgaclk_pll_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm vgaclk_pll_exdes -w routed.ncd routed.vhd
cd ..
